...
const DataUploadCardContent = () => {
  ...
  const { currentStep, fileInfo, setFileInfo, setRawData, rawData, setProceedAvailable } = useContext(WorkflowContext);
